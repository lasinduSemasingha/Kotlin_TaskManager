...
import lasindu.example.tempo.sample.databinding.ActivityRegisterBinding
...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun registerDatabase(firstName: String, lastName: String, age: Int, email: String, username: String, password: String) {
        if (firstName.isBlank() || lastName.isBlank() || age <= 0 || email.isBlank() || username.isBlank() || password.isBlank()) {
